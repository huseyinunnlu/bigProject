										...
										<div class="tab-pane active" id="settings">
											...
											<form class="form-horizontal" @submit.prevent="updateAnimal">
												<div class="form-group row">
													<img v-if="preview" :src="preview" style="width:100px; height:100px;">
													<img v-else :src="animal.image" style="width:100px; height:100px;">
												</div>	
												<div class="form-group row">
	...
	export default{
		...
		data(){
			return {
				...
				{name:'yesterday',value:'Today -1 Day'},
				{name:'A week',value:'Today -1 Week'},
				{name:'A mounth',value:'Today -1 Mounth'}],
				error:[],
				message:false,
				milkMessage:false,
				delMessage:false,
